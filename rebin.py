...
def binHisto(hist, rerror):
    binning = array.array('d',computeBinning(hist,rerror))
    hist = hist.Rebin(len(binning)-1,hist.GetName(),binning)
    return hist
...
binFile(0.3, 'mu_mle_theta_0210_nosignal.root','M_{t#bar{t}} [GeV/c^{2}]', ['data','ttbar','wl','wc','wb'])
