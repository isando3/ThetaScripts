...
TString get_sys_name(TString name)
{
  ...
  if (out.Contains("MuonSF")) res = "muonsf";
  if (out.Contains("PU")) res = "pu";
  if (out.Contains("LJets")) res = "ljets";
  if (out.Contains("BJets")) res = "bjets";
  if (out.Contains("matching")) res = "matching";
  if (out.Contains("scale")) res = "scale";
